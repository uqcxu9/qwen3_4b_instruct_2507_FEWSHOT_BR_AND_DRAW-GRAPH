...
data_path = r'/workspace/QWEN2.5_42_7b_main/data/gpt-3-noperception-reflection-1-100agents-240months_3'
...
if len(good_decisions) == 0:
    ...
    # Save
    output_path = '/workspace/QWEN2.5_42_7b_main/data/gpt-3-noperception-reflection-1-100agents-240months/good_decisions.csv_3'
