...
BASE = r"/workspace/QWEN2.5_42_7b_BUFFER"
MODEL = "gpt-3-noperception-reflection-1-100agents-240months_buffer3"
...
def save_csv(yearly_gdp, years):
    ...
    if growth_rates:
        ...
        print(f"约束 [-2.0, 6.7] 不满足率: {n_violate}/{len(growth_rates)} ({rate:.1f}%)")
