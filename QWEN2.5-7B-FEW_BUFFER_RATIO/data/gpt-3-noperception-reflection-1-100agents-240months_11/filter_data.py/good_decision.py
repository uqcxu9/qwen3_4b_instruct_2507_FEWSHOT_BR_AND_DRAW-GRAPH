...
data_path = r'/workspace/QWEN2.5-7B-FEW_BUFFER_RATIO/data/gpt-3-noperception-reflection-1-100agents-240months_11'
...
if len(good_decisions) == 0:
    ...
    # Save
    output_path = os.path.join(data_path, 'good_decisions.csv')
